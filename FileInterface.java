...
public interface FileInterface extends Remote {
    ...
    // void escribe(OutputStream os) throws IOException; //Escribir contenido del
    // archivo a OS
    ...
    void copiar(String nombrearchivodestino) throws RemoteException; // Copiar contenido del archivo original en otro
                                                                     // archivo destino
